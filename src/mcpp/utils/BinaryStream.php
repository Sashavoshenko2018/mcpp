    ...
    public function checkSkinData(&$skinData, &$skinGeomtryName, &$skinGeomtryData, &$additionalSkinData)
    {
        ...
        if(isset($additionalSkinData['PersonaSkin']) && $additionalSkinData['PersonaSkin']){
            ...
            if(empty($defaultSkins)){
                $defaultSkins[] = [file_get_contents(__DIR__ . "../resources/skins/Alex.dat"), 'geometry.humanoid.customSlim'];
                $defaultSkins[] = [file_get_contents(__DIR__ . "../resources/skins/Steve.dat"), 'geometry.humanoid.custom'];
            }
