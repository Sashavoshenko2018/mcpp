...
use mcpp\event\player\PlayerCreationEvent;
...
use mcpp\event\server\DataPacketSendEvent;
use mcpp\event\TextContainer;
use mcpp\event\Timings;
use mcpp\inventory\BaseTransaction;
use mcpp\inventory\BigShapedRecipe;
use mcpp\inventory\BigShapelessRecipe;
...
class Player extends Human implements CommandSender, InventoryHolder, IPlayer {
	...
	/**
	 * @var \mcpp\scheduler\TaskHandler[]
	 */
	protected $tasks = [];
