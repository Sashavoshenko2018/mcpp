...
use mcpp\event\server\QueryRegenerateEvent;
...
use mcpp\network\raklib\server\RakLibServer;
use mcpp\network\raklib\server\ServerHandler;
use mcpp\network\raklib\server\ServerInstance;
...
//		\mcpp\MINECRAFT_VERSION_NETWORK.";".
		''.";".
