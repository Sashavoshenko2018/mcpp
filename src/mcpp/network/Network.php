...
use mcpp\network\protocol\Info113 as ProtocolInfo113;
...
use mcpp\network\protocol\v113\CommandRequestPacket;
use mcpp\network\protocol\v113\InventoryContentPacket;
use mcpp\network\protocol\v113\InventoryTransactionPacket;
use mcpp\network\protocol\v113\ModalFormResponsePacket;
use mcpp\network\protocol\v113\PlayerHotbarPacket;
use mcpp\network\protocol\v113\PlayerSkinPacket;
use mcpp\network\protocol\v113\PurchaseReceiptPacket;
use mcpp\network\protocol\v113\ServerSettingsRequestPacket;
...
class Network
{
    ...
    private function registerPackets113()
    {
        ...
        $this->registerPacket113(ProtocolInfo113::TILE_EVENT_PACKET, TileEventPacket::class);
        ...
        $this->registerPacket113(ProtocolInfo113::TILE_ENTITY_DATA_PACKET, TileEntityDataPacket::class);
        ...
        $this->registerPacket113(ProtocolInfo113::CHUNK_RADIUS_UPDATE_PACKET, ChunkRadiusUpdatePacket::class);
        $this->registerPacket113(ProtocolInfo113::AVAILABLE_COMMANDS_PACKET, AvailableCommandsPacket::class);
        $this->registerPacket113(ProtocolInfo113::TRANSFER_PACKET, TransferPacket::class);
        $this->registerPacket113(ProtocolInfo113::CLIENT_TO_SERVER_HANDSHAKE_PACKET, ClientToServerHandshakePacket::class);
        $this->registerPacket113(ProtocolInfo113::RESOURCE_PACK_DATA_INFO_PACKET, ResourcePackDataInfoPacket::class);
        $this->registerPacket113(ProtocolInfo113::RESOURCE_PACKS_INFO_PACKET, ResourcePackDataInfoPacket::class);
        $this->registerPacket113(ProtocolInfo113::RESOURCE_PACKS_CLIENT_RESPONSE_PACKET, ResourcePackClientResponsePacket::class);
        ...
        // new
        $this->registerPacket113(ProtocolInfo113::INVENTORY_TRANSACTION_PACKET, InventoryTransactionPacket::class);
        $this->registerPacket113(ProtocolInfo113::INVENTORY_CONTENT_PACKET, InventoryContentPacket::class);
        $this->registerPacket113(ProtocolInfo113::PLAYER_HOTBAR_PACKET, PlayerHotbarPacket::class);
        $this->registerPacket113(ProtocolInfo113::COMMAND_REQUEST_PACKET, CommandRequestPacket::class);
        $this->registerPacket113(ProtocolInfo113::PLAYER_SKIN_PACKET, PlayerSkinPacket::class);
        $this->registerPacket113(ProtocolInfo113::MODAL_FORM_RESPONSE_PACKET, ModalFormResponsePacket::class);
        $this->registerPacket113(ProtocolInfo113::SERVER_SETTINGS_REQUEST_PACKET, ServerSettingsRequestPacket::class);
        $this->registerPacket113(ProtocolInfo113::PURCHASE_RECEIPT_PACKET, PurchaseReceiptPacket::class);
        $this->registerPacket113(ProtocolInfo113::SUB_CLIENT_LOGIN_PACKET, SubClientLoginPacket::class);
