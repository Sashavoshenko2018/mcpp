...
use mcpp\network\protocol\v110\CommandRequestPacket;
use mcpp\network\protocol\v110\InventoryContentPacket;
use mcpp\network\protocol\v110\InventoryTransactionPacket;
use mcpp\network\protocol\v110\ModalFormResponsePacket;
use mcpp\network\protocol\v110\PlayerHotbarPacket;
...
class Network
{
    ...
    private function registerPackets110()
    {
        ...
        // new
        $this->registerPacket110(ProtocolInfo110::INVENTORY_TRANSACTION_PACKET, InventoryTransactionPacket::class);
        $this->registerPacket110(ProtocolInfo110::INVENTORY_CONTENT_PACKET, InventoryContentPacket::class);
        $this->registerPacket110(ProtocolInfo110::PLAYER_HOTBAR_PACKET, PlayerHotbarPacket::class);
        $this->registerPacket110(ProtocolInfo110::COMMAND_REQUEST_PACKET, CommandRequestPacket::class);
        $this->registerPacket110(ProtocolInfo110::PLAYER_SKIN_PACKET, PlayerSkinPacket::class);
        $this->registerPacket110(ProtocolInfo110::MODAL_FORM_RESPONSE_PACKET, ModalFormResponsePacket::class);
        $this->registerPacket110(ProtocolInfo110::SERVER_SETTINGS_REQUEST_PACKET, ServerSettingsRequestPacket::class);
        $this->registerPacket110(ProtocolInfo110::PURCHASE_RECEIPT_PACKET, PurchaseReceiptPacket::class);
        $this->registerPacket110(ProtocolInfo110::SUB_CLIENT_LOGIN_PACKET, SubClientLoginPacket::class);
