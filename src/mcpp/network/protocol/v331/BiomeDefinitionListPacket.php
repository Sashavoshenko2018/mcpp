...
namespace mcpp\network\protocol\v331;

use mcpp\network\protocol\Info331;
use mcpp\network\protocol\PEPacket;

class BiomeDefinitionListPacket extends PEPacket {

	const NETWORK_ID = Info331::BIOME_DEFINITION_LIST_PACKET;
	const PACKET_NAME = "BIOME_DEFINITION_LIST_PACKET";
	...
	public function encode($playerProtocol) {
		...
		$this->put(empty($this->namedtag) ? base64_decode(self::HARDCODED_NBT_BLOB) : $this->namedtag);
	}
