...
interface Info
{
    ...
    const ACCEPTED_PROTOCOLS = [110, 111, 112,113, 114, 115, 116, 117, 118, 119, 120, 134, 135, 136, 137, 140, 141, 150, 160, 200, 201, 220, 221, 222, 224, 223, 240, 250, 260, 261, 270, 271, 273, 274, 280, 281, 282, 290, 291, 310, 311, 312, 313, 330, 331, 332, 342, 340, 350, 351, 352, 353, 354, 360, 361, 370, 371, 385, 386, 387, 388, 389, 390];
    ...
    const PROTOCOL_114 = 114; // 1.1.6(UNOFFICIAL ADDED)
    const PROTOCOL_113 = 113; // 1.1.5(UNOFFICIAL ADDED)
    const PROTOCOL_112 = 112; // 1.1.2(UNOFFICIAL ADDED)
    const PROTOCOL_111 = 111; // 1.1.1(UNOFFICIAL ADDED)
    const PROTOCOL_110 = 110; // 1.1.0(UNOFFICIAL ADDED)
