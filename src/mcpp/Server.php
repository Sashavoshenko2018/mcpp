...
class Server
{
     ...
     * @return PackManager
     */
    public function getPackManager()
    {
    ...
    public function saveOfflinePlayerData($name, Compound $nbtTag, $async = false)
    {
        ...
        try{
            ...
            if(DEBUG > 1 and $this->logger instanceof MainLogger){
    ...
    public function __construct(ClassLoader $autoloader, ThreadedLogger $logger, $filePath, $dataPath, $pluginPath)
    {
        ...
        if($this->logger instanceof MainLogger){
            $this->logger->setLogDebug(DEBUG > 1);
        }
    ...
    public function start()
    {
        ...
        $this->logger->info("Done (" . round(microtime(true) - START_TIME, 3) . 's)! For help, type "help" or "?"');
